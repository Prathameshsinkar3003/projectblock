    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2 style="font-size:22px;"><span>Upload</span> File</h2>         
        </div>
 
          <form role="form" action="UploadFileController" method="post" enctype="multipart/form-data">
                            <fieldset>
              ...
              <input type="text" name="username" class="form-control custom-labels" title="" required="required" value="${email}" readonly/>
              </div> <br>	
                  
                                <button type="submit" class="btn btn-lg btn-success btn-block">Upload</button><br>
                            </fieldset>
                        </form>
