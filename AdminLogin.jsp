...
<!-- ======= Contact Section ======= -->
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="row">
       <div class="col-lg-6">
         <form action="AdminLoginController" method="post" class="formone">
          <div class="row">           
       ...
       <br><br><a href="AdminRegister.jsp" style="color:green;">Register here!!!</a>
       </div>
        </form>
</div>
 <div class="col-lg-6">
 <img src="assets/img/admin.jpg" class="img-fluid" alt="" width="500px;" height="300px;">
 </div>
</div>
      </div>
