    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2 style="font-size:22px;"><span>Change</span> Password</h2>
          
        </div>
 <form action="StudentChangePasswordController" method="post">
		  <div class="row">         
          <div class="col-lg-6"> 
        <div class="form-group mt-1">          
         ...
         <input type="submit" value="Change Password" class="btn-get-started" style="color:#fff;"><br><br>
   
         <br><br>    
            
              </div></div>  </div>  
              <div class="col-lg-6">
              <img alt="" src="assets/img/chagepwd.jpg" width="500px;" height="300px;	">
               </div> </div>         
            </form>
