    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2 style="font-size:22px;"><span>Student</span> Profile</h2>
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                     <%response.setContentType("text/html");  
                      if(session!=null){  
	                String std_address=(String)session.getAttribute("std_address"); 	          
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                     <%response.setContentType("text/html");  
                      if(session!=null){  
	                String std_mobileno=(String)session.getAttribute("std_mobileno"); 	          
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                     <%response.setContentType("text/html");  
                      if(session!=null){  
	                String std_dob=(String)session.getAttribute("std_dob"); 	          
	                out.print(" "+std_dob+""); }   %>
                    </div>
                  </div>
