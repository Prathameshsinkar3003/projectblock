			...
			<div class="container">  -->
				<div class="row">
                    ...
                    <table class="table table-bordered" style="color:black">
                     ...
                     ResultSet rs=st.executeQuery("select * from tbl_files");
                     //while(rs.next())
                     if(rs.next() == false) {
                    	%>
                    	...
                    	<%-- <td><img alt="Profile Pic" class="img-circle" src="Profilepic.jsp?id=<%=rs.getInt(1) %>"  width="100px" height="80px"/></td>
                    	 ...
                    	 <td><a href="CheckFileController?id=<%=rs.getInt(1)%>&username=<%=rs.getString(2)%>&filename=<%=rs.getString(3)%>&file=<%=rs.getString(4)%>"><b>Verify File</b></a></td>
                    	 </TR>                    	 
                    <%count++; }while(rs.next());}%> 
