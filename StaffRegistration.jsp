...
<!-- ======= Contact Section ======= -->
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="row">
       <div class="col-lg-6">
         <form action="StaffRegistrationController" method="post" class="formone">
          <div class="row">
       ...
       <br><br><a href="StaffLogin.jsp" style="color:green;">Login here!!!</a></div>
        </form>
</div>
 <div class="col-lg-6">
 <img src="assets/img/staff.jpg" class="img-fluid" alt="" width="500px;" height="300px;">
 </div>
</div>
</div>
